...
class OrderStatisticsServiceTest {
    ...
    void sendOrderStatisticsMail() {
        ...
        Product product1 = createProduct("001", ProductType.HANDMADE, SELLING, "아메리카노", 1000);
        Product product2 = createProduct("002", ProductType.HANDMADE, HOLD, "카페라떼", 2000);
        Product product3 = createProduct("003", ProductType.HANDMADE, STOP_SELLING, "팥빙수", 3000);
